...
private Solucion4(List<Integer> ls) {
	...
	camino = aux.stream().map(i -> Datos4.getVertex(i)+"").collect(Collectors.joining(" ->\n\t", "Recorrido:\n\t", ""));
	totalTime = Cromosoma4.totalDuracion(ls) ; // TODO tiempo total empleado
	avgTime = totalTime / Datos4.N;
	totalEffort = Cromosoma4.goal(ls); // TODO esfuerzo total empleado
	avgEffort = totalEffort / Datos4.N;
	monCons = Cromosoma4.totalConsecutivos(ls); // TODO Nº de lugares conmonumento consecutivos a otro con monumento
}
